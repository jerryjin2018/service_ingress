#!/usr/bin/env python
# This is for test -- application two
...
def return_dict():
    ...
    dict_here = [
        {'id': 1, 'name': 'jerry', 'link': 'music/jerry.mp3', 'genre': 'General', 'chill out': 5},
        {'id': 2, 'name': 'tom','link': 'music/tom.mp3', 'genre': 'Bollywood', 'rating': 4},
        {'id': 3, 'name': 'kitty', 'link': 'music/kitty.mp3', 'genre': 'Bollywood', 'rating': 4}
        ]
    return dict_here
